import { 
  ...
  CertificateTemplate, EventAnnouncement, AuditLogEntry, EventHostingDocument 
} from '../types';
import { ALL_STATE_AND_UT_NAMES } from '../utils/locationData';

export const MOCK_INDIAN_STATES = [
  'All India',
  ...ALL_STATE_AND_UT_NAMES
];
...
export const INITIAL_CURRENT_USER: User = {
  ...
  twitter: 'https://x.com/aarav_ai_dev',
  leetcode: 'https://leetcode.com/aarav_codes',
  instagram: 'https://instagram.com/aarav_sharma_tech',
...
export const MOCK_STUDENTS: User[] = [
  INITIAL_CURRENT_USER,
  {
    ...
    github: 'https://github.com/pooja-embedded',
    linkedin: 'https://linkedin.com/in/pooja-iyer-hardware',
    leetcode: 'https://leetcode.com/pooja_circuits',
    role: 'student',
    connectionsCount: 34,
  ...
  },
  {
    ...
    github: 'https://github.com/vikram-cad',
    linkedin: 'https://linkedin.com/in/vikram-deshmukh-aero',
    role: 'student',
    connectionsCount: 42,
  ...
  },
  {
    ...
    linkedin: 'https://linkedin.com/in/ananya-sen-design',
    twitter: 'https://x.com/ananya_ux',
    instagram: 'https://instagram.com/ananya_design_lab',
    role: 'student',
    connectionsCount: 29,
...
export const MOCK_MENTORS: Mentor[] = [
  {
    ...
    github: 'https://github.com/dr-arvind-rao',
    twitter: 'https://x.com/arvind_rao_ai',
    leetcode: 'https://leetcode.com/u/arvind_rao_algo',
    instagram: 'https://instagram.com/arvind_rao_ai',
    socialLinks: {
      linkedin: 'https://linkedin.com/in/dr-arvind-rao-iitb',
      github: 'https://github.com/dr-arvind-rao',
      twitter: 'https://x.com/arvind_rao_ai',
    ...
    vidwan_profile_url: 'https://vidwan.inflibnet.ac.in/profile/108920',
    isDemoData: true,
    status: 'active'
  },
  {
    ...
    github: 'https://github.com/priya-sundaram-aero',
    twitter: 'https://x.com/priya_flight',
    leetcode: 'https://leetcode.com/u/priya_flight_dev',
    instagram: 'https://instagram.com/priya_sundaram_aero',
    socialLinks: {
      linkedin: 'https://linkedin.com/in/dr-priya-sundaram',
      github: 'https://github.com/priya-sundaram-aero',
      twitter: 'https://x.com/priya_flight',
    ...
    vidwan_profile_url: 'https://vidwan.inflibnet.ac.in/profile/114509',
    isDemoData: true,
    status: 'active'
  },
  {
    id: 'mnt-003',
    name: 'Dr. Rajeshwari Kalyani',
    email: 'rajeshwari.k@nitk.edu.in',
    mobile: '+91 94481 67890',
    title: 'Professor of VLSI & Embedded Systems',
    designation: 'Professor & Head of Electronics Design Center',
    qualification: 'Ph.D. in Microelectronics & Embedded Architecture (IIT Madras)',
    institution: 'National Institute of Technology Karnataka (NITK Surathkal)',
    department: 'Department of Electronics & Communication Engineering',
    specialization: 'Low-Power VLSI, TinyML Accelerators, RISC-V SoC Architecture',
    yearsExperience: 16,
    academicExp: '12 Years NITK Faculty',
    industryExp: '4 Years Lead ASIC Designer at Texas Instruments',
    researchAreas: ['RISC-V Microcontrollers', 'Hardware AI Accelerators', 'Edge Telemetry SoC'],
    projectsGuided: 42,
    certifications: ['IEEE Senior Member', 'Cadence Certified Fellow'],
    mentoringInterests: ['Semiconductor Design Challenges', 'Hardware Prototyping', 'IoT Gateways'],
    preferredDomains: ['Embedded VLSI', 'Edge AI', 'IoT'],
    availability: 'Available',
    maxTeams: 4,
    activeTeamsCount: 2,
    mentorshipSlots: 2,
    completedMentorshipsCount: 28,
    verifiedMentor: true,
    avatar: 'https://images.unsplash.com/photo-1580894732444-8ecded7900cd?w=150&auto=format&fit=crop&q=80',
    rating: 4.95,
    reviewsCount: 34,
    bio: 'Guiding collegiate engineers in synthesizing custom silicon IP blocks, RISC-V microcontrollers, and ultra-low-power TinyML nodes.',
    state: 'Karnataka',
    city: 'Surathkal',
    linkedin: 'https://linkedin.com/in/rajeshwari-kalyani-vlsi',
    github: 'https://github.com/rajeshwari-vlsi',
    twitter: 'https://x.com/rajeshwari_vlsi',
    socialLinks: {
      linkedin: 'https://linkedin.com/in/rajeshwari-kalyani-vlsi',
      github: 'https://github.com/rajeshwari-vlsi',
      twitter: 'https://x.com/rajeshwari_vlsi'
    },
    vidwan_profile_url: 'https://vidwan.inflibnet.ac.in/profile/132890',
    isDemoData: true,
    status: 'active'
  },
  {
    id: 'mnt-004',
    name: 'Dr. Alok Mathur',
    email: 'alok.mathur@iitd.ac.in',
    mobile: '+91 98110 56789',
    title: 'Professor of Clean Energy & Microgrids',
    designation: 'Professor & Dean of Industry Consultancies',
    qualification: 'Ph.D. in Power Electronics & Smart Grids (IIT Delhi / Imperial College Postdoc)',
    institution: 'Indian Institute of Technology Delhi (IIT Delhi)',
    department: 'Department of Electrical Engineering & Energy Studies',
    specialization: 'Renewable Microgrids, EV Fast Charging Stations, Battery Management Systems',
    yearsExperience: 18,
    academicExp: '13 Years at IIT Delhi',
    industryExp: '5 Years Principal Grid Engineer at ABB Power Systems',
    researchAreas: ['Solid-State EV Chargers', 'Decentralized Microgrid Stability', 'Battery Thermal Runaway Modeling'],
    projectsGuided: 45,
    certifications: ['IEEE Fellow', 'INAE Fellow'],
    mentoringInterests: ['Clean Energy Hackathons', 'EV Innovation Challenges', 'Hardware Scale-up'],
    preferredDomains: ['Clean Energy', 'EV Systems', 'Electrical Engineering'],
    availability: 'Limited Slots',
    maxTeams: 3,
    activeTeamsCount: 2,
    mentorshipSlots: 1,
    completedMentorshipsCount: 31,
    verifiedMentor: true,
    avatar: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=150&auto=format&fit=crop&q=80',
    rating: 4.88,
    reviewsCount: 40,
    bio: 'Mentoring interdisciplinary teams on high-voltage power electronics converters and smart bidirectional EV battery storage systems.',
    state: 'Delhi (NCT)',
    city: 'New Delhi',
    linkedin: 'https://linkedin.com/in/alok-mathur-energy',
    github: 'https://github.com/alok-mathur-grid',
    twitter: 'https://x.com/alok_mathur_ev',
    socialLinks: {
      linkedin: 'https://linkedin.com/in/alok-mathur-energy',
      github: 'https://github.com/alok-mathur-grid',
      twitter: 'https://x.com/alok_mathur_ev'
    },
    vidwan_profile_url: 'https://vidwan.inflibnet.ac.in/profile/145620',
    isDemoData: true,
    status: 'active'
  }
];
...
export const MOCK_RESEARCHERS: Researcher[] = [
  {
    id: 'res-001',
    name: 'Kavya Ramanathan (PhD Scholar)',
    ...
    openForCollab: true,
    bio: 'Investigating lightweight encryption schemes for decentralized gradient aggregation on resource-constrained edge devices across agricultural sensor clusters.',
    state: 'Karnataka',
    city: 'Bengaluru',
    linkedin: 'https://linkedin.com/in/kavya-ramanathan-phd',
    github: 'https://github.com/kavya-federated',
    twitter: 'https://x.com/kavya_research',
    socialLinks: {
      linkedin: 'https://linkedin.com/in/kavya-ramanathan-phd',
      github: 'https://github.com/kavya-federated',
      twitter: 'https://x.com/kavya_research'
    },
    vidwan_profile_url: 'https://vidwan.inflibnet.ac.in/profile/184201',
    isDemoData: true,
    status: 'active'
  },
  {
    id: 'res-002',
    name: 'Dr. Debabrata Roy (Postdoc Fellow)',
    email: 'debabrata.roy@iitkgp.ac.in',
    scholarId: 'IITKGP-BIO-2021-089',
    university: 'Indian Institute of Technology Kharagpur',
    institution: 'IIT Kharagpur',
    department: 'School of Medical Science and Technology',
    researchArea: 'Bio-Robotics & EMG Neural Prosthetics',
    specialization: 'Myoelectric Signal Processing & Bionic Actuators',
    researchTopics: ['Neural Interfaces', 'EMG Signal Decoding', 'Soft Robotic Grippers', '3D Printed Exoskeletons'],
    interests: ['Prosthetics', 'Bio-Sensors', 'Rehabilitation Robotics'],
    guide: 'Prof. Koel Mukherjee',
    publicationsCount: 8,
    citationsCount: 215,
    hIndex: 6,
    datasets: ['IndianBionic-EMG-Grasp', 'ProstheticHand-CAD-Mesh'],
    verifiedResearcher: true,
    avatar: 'https://images.unsplash.com/photo-1537368910025-700350fe46c7?w=150&auto=format&fit=crop&q=80',
    openForCollab: true,
    bio: 'Developing low-cost 3D printed active bionic prostheses with embedded microcontrollers for amputees in rural India.',
    state: 'West Bengal',
    city: 'Kharagpur',
    linkedin: 'https://linkedin.com/in/debabrata-roy-biorobotics',
    github: 'https://github.com/debabrata-bionics',
    socialLinks: {
      linkedin: 'https://linkedin.com/in/debabrata-roy-biorobotics',
      github: 'https://github.com/debabrata-bionics'
    },
    vidwan_profile_url: 'https://vidwan.inflibnet.ac.in/profile/159402',
    isDemoData: true,
    status: 'active'
  },
  {
    id: 'res-003',
    name: 'Sneha Mukherjee (PhD Scholar)',
    email: 'sneha.m@iitm.ac.in',
    scholarId: 'IITM-CHEM-2023-112',
    university: 'Indian Institute of Technology Madras',
    institution: 'IIT Madras',
    department: 'Department of Chemical Engineering & Clean Energy',
    researchArea: 'Solid-State Electrolytes & Sodium-Ion Battery Chemistry',
    specialization: 'Next-Gen Energy Storage & Thermal Runaway Mitigation',
    researchTopics: ['Sodium-Ion Batteries', 'Solid Electrolytes', 'EV Battery Pack Safety', 'Electrochemistry'],
    interests: ['Clean Energy', 'Battery Management', 'Renewable Storage'],
    guide: 'Prof. R. Raghu',
    publicationsCount: 4,
    citationsCount: 98,
    hIndex: 3,
    datasets: ['NaIon-Electrolyte-Conductivity-10K'],
    verifiedResearcher: true,
    avatar: 'https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=150&auto=format&fit=crop&q=80',
    openForCollab: true,
    bio: 'Synthesizing non-flammable solid polymer-ceramic composite electrolytes for electric 2-wheeler battery packs in Indian climatic conditions.',
    state: 'Tamil Nadu',
    city: 'Chennai',
    linkedin: 'https://linkedin.com/in/sneha-mukherjee-energy',
    twitter: 'https://x.com/sneha_batteries',
    socialLinks: {
      linkedin: 'https://linkedin.com/in/sneha-mukherjee-energy',
      twitter: 'https://x.com/sneha_batteries'
    },
    vidwan_profile_url: 'https://vidwan.inflibnet.ac.in/profile/204891',
    isDemoData: true,
    status: 'active'
  },
  {
    id: 'res-004',
    name: 'Tenzing Norbu (PhD Scholar)',
    email: 'tenzing.norbu@iitr.ac.in',
    scholarId: 'IITR-WRD-2022-034',
    university: 'Indian Institute of Technology Roorkee',
    institution: 'IIT Roorkee',
    department: 'Department of Water Resources Development & Management',
    researchArea: 'Himalayan Glacial Lake Outburst Flood (GLOF) Early Warning',
    specialization: 'Satellite Synthetic Aperture Radar (SAR) & Hydrological Hydrodynamics',
    researchTopics: ['GLOF Early Warning', 'Satellite Radar Interferometry', 'Flood Modeling', 'LoRa Remote Mesh'],
    interests: ['Disaster Early Warning', 'Hydrology', 'Remote Sensing'],
    guide: 'Prof. Arun Kumar',
    publicationsCount: 5,
    citationsCount: 130,
    hIndex: 4,
    datasets: ['HimalayanGlacialLakes-SAR-Timeseries'],
    verifiedResearcher: true,
    avatar: 'https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?w=150&auto=format&fit=crop&q=80',
    openForCollab: true,
    bio: 'Deploying solar-powered LoRa satellite telemetry gauges on high-altitude moraine dam lakes in Uttarakhand and Sikkim for real-time flood warning.',
    state: 'Uttarakhand',
    city: 'Roorkee',
    linkedin: 'https://linkedin.com/in/tenzing-norbu-glof',
    github: 'https://github.com/tenzing-sar-hydro',
    socialLinks: {
      linkedin: 'https://linkedin.com/in/tenzing-norbu-glof',
      github: 'https://github.com/tenzing-sar-hydro'
    },
    vidwan_profile_url: 'https://vidwan.inflibnet.ac.in/profile/172340',
    isDemoData: true,
    status: 'active'
  },
  {
    id: 'res-005',
    name: 'Aniruddha Deshmukh (PhD Scholar)',
    email: 'aniruddha.d@tifr.res.in',
    scholarId: 'TIFR-PHYS-2021-018',
    university: 'Tata Institute of Fundamental Research (TIFR Mumbai)',
    institution: 'TIFR Mumbai',
    department: 'Department of Condensed Matter Physics & Quantum Materials',
    researchArea: 'Room-Temperature Quantum Magnetometry with Diamond NV Centers',
    specialization: 'Quantum Sensing, Nanoscale Magnetic Imaging & Optically Detected Magnetic Resonance',
    researchTopics: ['NV Center Magnetometry', 'Quantum Metrology', 'Bio-Magnetic Sensing', 'Microwave Resonators'],
    interests: ['Quantum Computing', 'Nanoscale Sensors', 'Optics'],
    guide: 'Prof. S. Dhar',
    publicationsCount: 7,
    citationsCount: 185,
    hIndex: 5,
    datasets: ['Diamond-NV-ODMR-Spectral-Data'],
    verifiedResearcher: true,
    avatar: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=150&auto=format&fit=crop&q=80',
    openForCollab: true,
    bio: 'Designing portable diamond nitrogen-vacancy quantum magnetometers for non-invasive magnetic cardiac diagnostics and underground geological surveys.',
    state: 'Maharashtra',
    city: 'Mumbai',
    linkedin: 'https://linkedin.com/in/aniruddha-deshmukh-quantum',
    twitter: 'https://x.com/aniruddha_quantum',
    socialLinks: {
      linkedin: 'https://linkedin.com/in/aniruddha-deshmukh-quantum',
      twitter: 'https://x.com/aniruddha_quantum'
    },
    vidwan_profile_url: 'https://vidwan.inflibnet.ac.in/profile/219804',
    isDemoData: true,
    status: 'active'
  },
  {
    id: 'res-006',
    name: 'Divya Swaminathan (PhD Scholar)',
    email: 'divya.s@nitt.edu',
    scholarId: 'NITT-ECE-2023-057',
    university: 'National Institute of Technology Tiruchirappalli',
    institution: 'NIT Trichy',
    department: 'Department of Electronics and Communication Engineering',
    researchArea: 'Swarm UAV Mesh Ad-Hoc Routing in GPS-Denied Disaster Zones',
    specialization: 'UWB Ranging, Autonomous Swarm Flocking & Resilient Routing',
    researchTopics: ['UAV Swarms', 'Ultra-Wideband (UWB)', 'Ad-Hoc Networks', 'Disaster Recovery'],
    interests: ['Drone Swarms', 'Wireless Protocols', 'Emergency Comms'],
    guide: 'Prof. G. Lakshminarayanan',
    publicationsCount: 5,
    citationsCount: 110,
    hIndex: 4,
    datasets: ['UAV-Swarm-UWB-Ranging-Traces'],
    verifiedResearcher: true,
    avatar: 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=150&auto=format&fit=crop&q=80',
    openForCollab: true,
    bio: 'Creating decentralized mesh consensus and relative UWB localization protocols for autonomous multi-rotor swarms navigating collapsed underground mines.',
    state: 'Tamil Nadu',
    city: 'Tiruchirappalli',
    linkedin: 'https://linkedin.com/in/divya-swaminathan-uav',
    github: 'https://github.com/divya-swarm-mesh',
    socialLinks: {
      linkedin: 'https://linkedin.com/in/divya-swaminathan-uav',
      github: 'https://github.com/divya-swarm-mesh'
    },
    vidwan_profile_url: 'https://vidwan.inflibnet.ac.in/profile/193248',
    isDemoData: true,
    status: 'active'
  }
];
